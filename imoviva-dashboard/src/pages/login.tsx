...
import { FormDataLogin, LoginSchema } from "../Components/Schemas/LoginSchemas";
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form onSubmit={handleSubmit(handleLogin)} className="space-y-4">
                    ...
                    <div>
                        <button
                            type="submit"
                            className="flex w-full justify-center rounded-md font-normal bg-orange-600 px-3 py-1.5 text-sm leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 "
                        >
                            {loading ? (
                                <Loader /> 
                            ): "Entrar"}
