...
import { usePropertiesGround } from "../UseProperties/UsePropertiesGround"

export const FormGround = () => {

    const { errors, handleFormSubmit, handleSubmit, register } = usePropertiesGround()
    return (
       <form onSubmit={handleSubmit(handleFormSubmit)}>
            <h1 className="text-center text-3xl">Cadastrar Casas</h1>
